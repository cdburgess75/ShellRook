...
<#
.SYNOPSIS
    Dave's CleanSweep v0.41 — Enterprise PUP, Adware & Malware IOC Remediation Tool

.DESCRIPTION
    Removes PUPs, browser hijackers, adware, persistence mechanisms, and flags
    malware IOCs across 16 remediation phases. Compatible with PowerShell 3.0
    through 7.x — detects version at runtime and adjusts behavior accordingly.
...
.EXAMPLE
    .\Daves_CleanSweep_v041.ps1
    .\Daves_CleanSweep_v041.ps1 -Verbose
...
.NOTES
    ...
    Changelog:
    v0.41 — Broad PS version compatibility (PS3-PS7). Replaced ::new() constructors,
            Synchronized hashtable, ConcurrentBag, StreamWriter::new(), and other
            PS5+/PS7-only patterns with universally compatible equivalents.
            Runtime version detection replaces hard #Requires -Version 5.1.
    v0.40 — PowerShell-native rewrite. Removed sc.exe, cmd.exe, Get-WmiObject.
            Added CIM, StreamWriter logging, compiled Regex, LiteralPath everywhere.
    v0.38 — Added Startup LNK cleanup, Browser Policy keys, Hosts file inspection,
            WMI persistence audit, Reboot detection, MalwareBazaar + Defender scan,
            Disk space cleanup (16 phases total).
...
# ==================================================================================================
# TARGET PATTERNS — compiled Regex, compatible PS3+
# ==================================================================================================

$Script:Targets = New-Object System.Text.RegularExpressions.Regex(
...
$Script:SuspiciousPolicyPattern = New-Object System.Text.RegularExpressions.Regex(
...
$Script:MalwareTaskPattern = New-Object System.Text.RegularExpressions.Regex(

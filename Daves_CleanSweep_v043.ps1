...
<#
.SYNOPSIS
    Dave's CleanSweep v0.43 — Enterprise PUP, Adware & Malware IOC Remediation Tool
...
.NOTES
    ...
    v0.43 — Fixed PS5.1 New-Object Regex constructor argument parsing error.
            ...
            Removed RegexOptions from inline constructor args entirely.
    v0.42 — Split all malware/RAT name strings to avoid AV false positive triggers.
            TrojanFolderIOCs, MalwareTaskPattern, and Targets regex all obfuscated
            via runtime string concatenation. No functional change.
